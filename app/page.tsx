      ...
      <main>
        ...
        <section className="bg-lavender section">
          <div className="container-site">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-indigo-brand/10 rounded-3xl overflow-hidden">
              {[
            ...
            <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
              {agenda.days.map((day, i) => (
                <a
                  key={day.id}
                  href={`/agenda#${day.id}`}
                  className="group block rounded-3xl bg-white p-8 hover:shadow-md transition-shadow"
                >
